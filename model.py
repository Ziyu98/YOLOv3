        ...
        with slim.arg_scope([slim.conv2d, slim.batch_norm], reuse=reuse):
            with slim.arg_scope([slim.conv2d], 
                ...
                with tf.variable_scope('darknet53_body'):
                    route_1, route_2, route_3, net1, net3, net5 = darknet53_body(inputs)
                ...
                with tf.variable_scope('yolov3_head'):
                    ...
                    layer1 = tf.identity(net1, name='layer1')
                    layer3 = tf.identity(net3, name='layer3')
                    layer5 = tf.identity(net5, name='layer5')
                    layer7 = tf.identity(route_1, name='layer7')
                    layer9 = tf.identity(route_2, name='layer9')
                    layer11 = tf.identity(route_3, name='layer11')

            return layer1, layer3, layer5, layer7, layer9, layer11, feature_map_1, feature_map_2, feature_map_3
